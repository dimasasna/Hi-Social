...
const ServiceOffer = () => {
    return (
        <section className="mb-6 m-12 z-40">
            ...
            <div className="h-full mt-12 grid grid-cols-2 gap-2 max-w-[1230px] mx-auto">
                <div className="w-full -ml-4">
                    <img src={imgOffer} alt="offer 1" className=" w-full h-full" />
                </div>
                <div className="flex flex-col fex-wrap gap-9">
                    <div className="h-[206px] max-w-[600px] rounded-[20px]  shadow-2xl">
                        ...
                        <div className="p-6">
                            <p className="leading-7  text-[18px]">We craft unique visual elements, from logos and color palettes to typography and imagery, tailored to your brands personality and message.</p>
                        </div>
                    </div>
                    <div className="h-[206px] w-[600px] rounded-[20px] shadow-2xl">
                        ...
                        <div className="p-6">
                            <p className="leading-7  text-[18px]">Our team of talented designers will create stunning visuals that captivate your audience and reinforce your brands story.</p>
                        </div>
                    </div>
                    <div className="h-[206px] w-[600px] rounded-[20px] shadow-2xl">
                        <div className="border-b-2 h-[70px] flex justify-between items-center p-6">
                        ...
                        <div className="p-6">
                            <p className="leading-7  text-[18px]">Our Branding Identity Visual Service will empower your brand to soar and leave an indelible mark.</p>
                        </div>
                    </div>
                </div>
