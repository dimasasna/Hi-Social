...
const ServiceTesti = () => {
    return (
        <section className="bg-[#008FFF] h-[594px] w-full mb-12">
            <div className="mx-auto pt-16  max-w-[1230px]">
            ...
            <div className=" my-12 flex flex-row flex-wrap gap-10 justify-center items-center  max-w-[1230px] mx-auto">
                <div className="w-[350px] h-[258px] rounded-[20px] bg-white shadow-lg flex  flex-col items-center p-4">
                ...
                <div className=" w-[435px] h-[314px] rounded-[20px] bg-white shadow-lg flex  flex-col items-center p-4">
